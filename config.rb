  ...
  options.Targets =
      {
          ...
          # :test =>
          #     {
          #         :CFBundleID  => 'com.balthisar.middlemac.test.help',
          #         :ProductName => 'Middlemac Test',
          #         :Features =>
          #             {
          #                 :feature_advertise_pro        => true,
          #                 :feature_performs_miracles    => false,
          #                 :feature_insults_user         => false,
          #                 :feature_shows_pink_rectangle => false,
          #             }
          #     },
